...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1ea9f6af
    m_timestamp = 0;
    // m_timestamp_sample com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6a192cfe
    m_timestamp_sample = 0;
    // m_xy_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5119fb47
    m_xy_valid = false;
    // m_z_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7193666c
    m_z_valid = false;
    // m_v_xy_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@20deea7f
    m_v_xy_valid = false;
    // m_v_z_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3835c46
    m_v_z_valid = false;
    ...
    m_z = 0.0;
    // m_delta_xy com.eprosima.idl.parser.typecode.AliasTypeCode@393671df
    memset(&m_delta_xy, 0, (2) * 4);
    // m_xy_reset_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@56620197
    m_xy_reset_counter = 0;
    // m_delta_z com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6eda5c9
    m_delta_z = 0.0;
    // m_z_reset_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@55b7a4e0
    m_z_reset_counter = 0;
    // m_vx com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5f058f00
    m_vx = 0.0;
    // m_vy com.eprosima.idl.parser.typecode.PrimitiveTypeCode@192d43ce
    m_vy = 0.0;
    // m_vz com.eprosima.idl.parser.typecode.PrimitiveTypeCode@72057ecf
    m_vz = 0.0;
    // m_z_deriv com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1afd44cb
    m_z_deriv = 0.0;
    // m_delta_vxy com.eprosima.idl.parser.typecode.AliasTypeCode@393671df
    memset(&m_delta_vxy, 0, (2) * 4);
    // m_vxy_reset_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6973b51b
    m_vxy_reset_counter = 0;
    // m_delta_vz com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1ab3a8c8
    m_delta_vz = 0.0;
    // m_vz_reset_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@43195e57
    m_vz_reset_counter = 0;
    // m_ax com.eprosima.idl.parser.typecode.PrimitiveTypeCode@333291e3
    m_ax = 0.0;
    // m_ay com.eprosima.idl.parser.typecode.PrimitiveTypeCode@479d31f3
    m_ay = 0.0;
    // m_az com.eprosima.idl.parser.typecode.PrimitiveTypeCode@40ef3420
    m_az = 0.0;
    // m_heading com.eprosima.idl.parser.typecode.PrimitiveTypeCode@498d318c
    m_heading = 0.0;
    // m_delta_heading com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6e171cd7
    m_delta_heading = 0.0;
    // m_heading_reset_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@402bba4f
    m_heading_reset_counter = 0;
    // m_heading_good_for_control com.eprosima.idl.parser.typecode.PrimitiveTypeCode@795cd85e
    m_heading_good_for_control = false;
    // m_xy_global com.eprosima.idl.parser.typecode.PrimitiveTypeCode@59fd97a8
    m_xy_global = false;
    // m_z_global com.eprosima.idl.parser.typecode.PrimitiveTypeCode@f5ac9e4
    m_z_global = false;
    // m_ref_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@123ef382
    m_ref_timestamp = 0;
    // m_ref_lat com.eprosima.idl.parser.typecode.PrimitiveTypeCode@dbf57b3
    m_ref_lat = 0.0;
    // m_ref_lon com.eprosima.idl.parser.typecode.PrimitiveTypeCode@384ad17b
    m_ref_lon = 0.0;
    // m_ref_alt com.eprosima.idl.parser.typecode.PrimitiveTypeCode@61862a7f
    m_ref_alt = 0.0;
    // m_dist_bottom com.eprosima.idl.parser.typecode.PrimitiveTypeCode@441772e
    m_dist_bottom = 0.0;
    // m_dist_bottom_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7334aada
    m_dist_bottom_valid = false;
    // m_dist_bottom_sensor_bitfield com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1d9b7cce
    m_dist_bottom_sensor_bitfield = 0;
    // m_eph com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4d9e68d0
    m_eph = 0.0;
    // m_epv com.eprosima.idl.parser.typecode.PrimitiveTypeCode@42e99e4a
    m_epv = 0.0;
    // m_evh com.eprosima.idl.parser.typecode.PrimitiveTypeCode@14dd9eb7
    m_evh = 0.0;
    // m_evv com.eprosima.idl.parser.typecode.PrimitiveTypeCode@52e6fdee
    m_evv = 0.0;
    // m_vxy_max com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6c80d78a
    m_vxy_max = 0.0;
    // m_vz_max com.eprosima.idl.parser.typecode.PrimitiveTypeCode@62150f9e
    m_vz_max = 0.0;
    // m_hagl_min com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1a451d4d
    m_hagl_min = 0.0;
    // m_hagl_max com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7fa98a66
    m_hagl_max = 0.0;
