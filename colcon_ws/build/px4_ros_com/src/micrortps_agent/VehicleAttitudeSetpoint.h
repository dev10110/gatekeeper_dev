...
namespace px4_msgs
{
    namespace msg
    {
        ...
        private:
            ...
            bool m_roll_reset_integral;
            bool m_pitch_reset_integral;
            bool m_yaw_reset_integral;
