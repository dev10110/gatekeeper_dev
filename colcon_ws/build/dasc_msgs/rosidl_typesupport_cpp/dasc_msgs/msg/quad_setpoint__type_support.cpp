...
static const _QuadSetpoint_type_support_symbol_names_t _QuadSetpoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dasc_msgs, msg, QuadSetpoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dasc_msgs, msg, QuadSetpoint)),
  }
};
...
{
  return &::dasc_msgs::msg::rosidl_typesupport_cpp::QuadSetpoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dasc_msgs, msg, QuadSetpoint)() {
  return get_message_type_support_handle<dasc_msgs::msg::QuadSetpoint>();
}
